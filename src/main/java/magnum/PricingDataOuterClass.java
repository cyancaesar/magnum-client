...
public final class PricingDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        StaticData.class.getName());
    }
    // Use StaticData.newBuilder() to construct.
    private StaticData(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private StaticData() {
      id_ = "";
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return PricingDataOuterClass.internal_static_StaticData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return PricingDataOuterClass.internal_static_StaticData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PricingDataOuterClass.StaticData.class, PricingDataOuterClass.StaticData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PricingDataOuterClass.StaticData)) {
        return super.equals(obj);
      }
      PricingDataOuterClass.StaticData other = (PricingDataOuterClass.StaticData) obj;
    ...
    public static PricingDataOuterClass.StaticData parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static PricingDataOuterClass.StaticData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PricingDataOuterClass.StaticData parseFrom(
    ...
    public static PricingDataOuterClass.StaticData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseWithIOException(PARSER, input);
    }
    ...
    public static PricingDataOuterClass.StaticData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static PricingDataOuterClass.StaticData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static Builder newBuilder(PricingDataOuterClass.StaticData prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        PricingDataOuterClass.StaticDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PricingDataOuterClass.internal_static_StaticData_descriptor;
      }
      ...
      // Construct using PricingDataOuterClass.StaticData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public PricingDataOuterClass.StaticData getDefaultInstanceForType() {
        return PricingDataOuterClass.StaticData.getDefaultInstance();
      }

      @java.lang.Override
      public PricingDataOuterClass.StaticData build() {
        PricingDataOuterClass.StaticData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public PricingDataOuterClass.StaticData buildPartial() {
        PricingDataOuterClass.StaticData result = new PricingDataOuterClass.StaticData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(PricingDataOuterClass.StaticData result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.id_ = id_;
        }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PricingDataOuterClass.StaticData) {
          return mergeFrom((PricingDataOuterClass.StaticData)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(PricingDataOuterClass.StaticData other) {
        if (other == PricingDataOuterClass.StaticData.getDefaultInstance()) return this;
        if (!other.getId().isEmpty()) {
          id_ = other.id_;
          bitField0_ |= 0x00000001;
          onChanged();
    ...
    private static final PricingDataOuterClass.StaticData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PricingDataOuterClass.StaticData();
    }

    public static PricingDataOuterClass.StaticData getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\023\n\013displayName\030\005 \001(\tb\006proto3"
    };
